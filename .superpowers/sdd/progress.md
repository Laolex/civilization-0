...
→ NEXT: whole-branch code review (most capable model) over bfee34d..29207f1, then superpowers:finishing-a-development-branch (PR; never merge to master directly).
